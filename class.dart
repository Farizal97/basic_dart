void main() {
  RekeningBank rekeningRifqi = new RekeningBank(namaBank: '', namaPemilik: '', saldo: 5000000);
...
class RekeningBank {
  ...
  RekeningBank.Owo({required this.namaPemilik, this.namaBank = 'OWO', required this.saldo});
